...
def p_test(train_df, test_df, alpha=1e-2):
...
def compare_df(label_0, label_1, output_path):
...
if __name__ == "__main__":
    output_path = r'\\mega\syli\dataset\EC_all\model\merge_all\merge_features'
    # excel_path = r'C:\Users\HJ Wang\Desktop\ML\My_work\210322placenta\临床.csv'
    group1 = np.array([0]*310 + [1]*87)
    group2 = np.array([0]*133 + [1]*37)
    group3 = np.array([0]*22 +  [1]*6)
