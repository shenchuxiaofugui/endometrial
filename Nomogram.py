...
def nomogram(path, result_title="Positive Risk", fig_width=10, single_height=0.45, dpi=100,
    ...
    xticks = [round(i, 2) for i in xticks[::2]]
    xticklabels = [round(i, 2) for i in xticklabels[::2]]
...
if __name__ == "__main__":
    a = nomogram(r"C:\Users\handsome\Desktop\瘤周\result\LNM\combine\merge\model.xlsx")
    plt.savefig(r"C:\Users\handsome\Desktop\瘤周\FIG\nomogram.png", dpi=300)